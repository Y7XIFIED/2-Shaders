;(function () {
	...
	function loop(t) {
		...
		gl.uniform1f(iTimeLoc, t * 0.0015) // Increased animation speed

		// Autonomous animation instead of mouse tracking
		let cx = canvas.width / 2
		let cy = canvas.height / 2
		state.mouseTarget[0] = cx + Math.sin(t * 0.0005) * (canvas.width * 0.4)
		state.mouseTarget[1] = cy + Math.cos(t * 0.0007) * (canvas.height * 0.4)
